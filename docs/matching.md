...
| [Mathias Gatti's question-only CSV, fixed January 21, 2022 revision](https://github.com/mathigatti/okCupidScraper/blob/47967ab9745e13300b46a7ead2e5c0d1b02fe216/questions.csv) | **3,318 question records** with choice arrays. 53 prompts match the official 2011 chart after case/punctuation/spacing normalization. | Establishes choices in this later file, not in 2011. We did not run the scraper or download member/profile/response datasets. The repository carries MIT terms; see [third-party notices](../THIRD_PARTY_NOTICES.md). Those terms do not establish ownership of every historical question. |
